...
public class OpcionesPartida extends JPanel implements Runnable {
	...
	public OpcionesPartida() {
		...
		this.textoElegir = new Resultado("ELEGIR TIPO DE PARTIDO", new Font("Times New Roman", Font.PLAIN, 40), 110, 250, Color.WHITE);
        this.opcionPuntaje = new Resultado("POR PUNTAJE", new Font("Times New Roman", Font.PLAIN, 40), 220, 350, Color.WHITE);
		this.opcionTemporizador = new Resultado("POR TIEMPO", new Font("Times New Roman", Font.PLAIN, 40), 230, 450, Color.WHITE);
